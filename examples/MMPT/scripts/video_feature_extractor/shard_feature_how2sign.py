...
if __name__ == "__main__":
    shard = Shard(
        "/exp/xzhang/slt/datasets/how2sign/features/all_full",
        "data/how2sign/features/s3d_shard_small",
        ["data/how2sign/annotations/train.lst", "data/how2sign/annotations/val.lst"]
    )
